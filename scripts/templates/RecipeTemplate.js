    ...
    getRecipeCardDOM() {
        const recipeCard = new DOMParser().parseFromString(`
                <article
                    ...
                    <span class="absolute top-5 right-5 bg-yellow p-1 px-4 rounded-full text-xs">${this._recipe.time}min</span>
                    <div class="px-8 py-8 flex flex-col gap-4" id="description">
                        <h2 class="font-anton text-lg text-black pb-2">${this._recipe.name}</h2>
